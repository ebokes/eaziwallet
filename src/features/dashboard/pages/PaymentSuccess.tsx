      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
          ...
          <div className="space-y-4">
            {/* Biller */}
            <div className="pb-4 border-b border-alice-blue">
              <p className="text-sm text-slate-gray mb-1">Biller</p>
            ...
            {/* Amount */}
            <div className="pb-4 border-b border-alice-blue">
              <p className="text-sm text-slate-gray mb-1">Amount</p>
              <p className="text-gray-900">{amount || "$132.32"}</p>
            </div>

            {/* Transaction Number */}
            <div>
              <p className="text-sm text-slate-gray mb-1">Transaction no.</p>
